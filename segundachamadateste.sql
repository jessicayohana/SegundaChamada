...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Ago-2018 às 01:06
...
INSERT INTO `aluno` (`matricula`, `email`, `senha`, `nome`, `turma`, `cod_turma`) VALUES
...
(2131346, 'jessicayohanaotto@gmail.com', '012345', 'jessica', NULL, NULL),
...
INSERT INTO `pedido` (`curso`, `turma`, `disciplina`, `professor`, `data`, `motivo`, `matricula`) VALUES
('informatica', 'terceirao', 'matematica', 'lui', '12092012', 'fecre', 0),
('Quimica', 'quarto', 'quimica', 'elder', '12032012', 'naosei', 0),
('Quimica', 'quarto', 'quimica', 'elder', '12032012', 'naosei', 0),
('Quimica', 'quarto', 'quimica', 'elder', '12032012', 'naosei', 0),
('informatica', 'terceirao', 'banco', 'ivo', '130678', 'togripada', 0),
('informatica', 'terceirao', 'redes', 'adamo', '10082018', 'dvopdreujvpo', 0),
('informatica', '3info1', 'redes', 'lui', '12092012', 'socorro', 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `pedidofabio`
--

CREATE TABLE `pedidofabio` (
  `data_parecer` varchar(80) DEFAULT NULL,
  `cod_pedido` int(12) NOT NULL,
  `data_inicial` varchar(80) DEFAULT NULL,
  `data_final` varchar(80) DEFAULT NULL,
  `observação` varchar(80) DEFAULT NULL,
  `motivo` varchar(80) DEFAULT NULL,
  `cod_coordenador` int(12) DEFAULT NULL,
  `status` varchar(80) DEFAULT NULL,
  `anexo` varchar(80) DEFAULT NULL,
  `data_pedido` varchar(80) DEFAULT NULL,
...
--
-- Indexes for table `pedidofabio`
--
ALTER TABLE `pedidofabio`
  ADD PRIMARY KEY (`cod_pedido`),
  ADD KEY `fk_coordenadoress` (`cod_coordenador`),
  ADD KEY `fk_aluno` (`matricula_aluno`);
...
--
-- Limitadores para a tabela `pedidofabio`
--
ALTER TABLE `pedidofabio`
  ADD CONSTRAINT `fk_aluno` FOREIGN KEY (`matricula_aluno`) REFERENCES `aluno` (`matricula`),
  ADD CONSTRAINT `fk_coordenadoress` FOREIGN KEY (`cod_coordenador`) REFERENCES `coordenador` (`cod_coordenador`);
